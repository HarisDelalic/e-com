...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @unique_title = "Great Book #{rand(1000)}"
  end
  ...
  test "should create product" do
    assert_difference('Product.count') do
      post products_url, params: { product: { description: @product.description, image_url: @product.image_url, price: @product.price, title:@unique_title } }
    end
